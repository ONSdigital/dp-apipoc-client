...
func TestPingWhenAPIServerIsAvailable(t *testing.T) {
	os.Setenv("API_SERVER_ROOT", "http://foo.com")
...
func TestGetDatasets(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		"http://foo.com/dataset?limit=1&start=0",
		func(req *http.Request) (*http.Response, error) {
			resp, err := httpmock.NewJsonResponse(200, respBody)
			if err != nil {
				return httpmock.NewStringResponse(500, ""), nil
...
func TestGetDatasetsForId(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		"http://foo.com/dataset/ukea?limit=1&start=0",
		func(req *http.Request) (*http.Response, error) {
			resp, err := httpmock.NewJsonResponse(200, respBody)
			if err != nil {
				return httpmock.NewStringResponse(500, ""), nil
...
func TestGetDatasetsForTimeseries(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		"http://foo.com/timeseries/nmcu/dataset?limit=1&start=0",
		func(req *http.Request) (*http.Response, error) {
			resp, err := httpmock.NewJsonResponse(200, respBody)
			if err != nil {
				return httpmock.NewStringResponse(500, ""), nil
...
func TestGetTimeseries(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		"http://foo.com/timeseries?limit=1&start=0",
		func(req *http.Request) (*http.Response, error) {
			resp, err := httpmock.NewJsonResponse(200, respBody)
			if err != nil {
				return httpmock.NewStringResponse(500, ""), nil
...
func TestGetTimeseriesForId(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		"http://foo.com/timeseries/nmcu?limit=1&start=0",
		func(req *http.Request) (*http.Response, error) {
			resp, err := httpmock.NewJsonResponse(200, respBody)
			if err != nil {
				return httpmock.NewStringResponse(500, ""), nil
...
func TestGetTimeseriesForDataset(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		"http://foo.com/dataset/UKEA/timeseries?limit=1&start=0",
		func(req *http.Request) (*http.Response, error) {
			resp, err := httpmock.NewJsonResponse(200, respBody)
			if err != nil {
				return httpmock.NewStringResponse(500, ""), nil
...
func TestGetDataset(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		"http://foo.com/dataset/UKEA/timeseries/nmcu",
		func(req *http.Request) (*http.Response, error) {
			resp, err := httpmock.NewJsonResponse(200, respBody)
			if err != nil {
				return httpmock.NewStringResponse(500, ""), nil
...
func TestSearchMetadata(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		"http://foo.com/search?limit=7&q=travel&start=3",
		func(req *http.Request) (*http.Response, error) {
			resp, err := httpmock.NewJsonResponse(200, respBody)
			if err != nil {
				return httpmock.NewStringResponse(500, ""), nil
...
func TestGetData(t *testing.T) {
	...
	httpmock.RegisterResponder(
		"GET",
		"http://foo.com/dataset/ukea/timeseries/cpcm/data",
		func(req *http.Request) (*http.Response, error) {
			resp, err := httpmock.NewJsonResponse(200, respBody)
			if err != nil {
				return httpmock.NewStringResponse(500, ""), nil
